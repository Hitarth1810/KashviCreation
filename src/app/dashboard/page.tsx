...
export default function Dashboard() {
  ...
  const [editAddress, setEditAddress] = useState<[boolean, string]>([false, ""]);
		...
		<div className='min-h-screen bg-[#FDF7F3]'>
			...
			<div className='flex'>
				...
				<main className='flex-1 p-6 md:p-6 pt-16 md:pt-6'>
																...
																<div className='mt-2 flex flex-col gap-2'>
																	...
																	{order.status === "PENDING" && (
																		<div className='bg-yellow-100 text-yellow-800 text-sm rounded-xl px-4 py-2 shadow-inner border border-yellow-300 mt-1'>
																			...
																			once your order is confirmed by the admin.
																		</div>
																	)}
																	{order.status === "CONFIRMED" && (
																		<div className='bg-yellow-100 text-yellow-800 text-sm rounded-xl px-4 py-2 shadow-inner border border-yellow-300 mt-1'>
																			📩 Your order has been successfully
																			placed, and an invoice has been sent to
																			your registered email address.
																			<br className='hidden sm:block' />
																			🕵️‍♂️ Don’t forget to check your spam folder
																			too!
																		</div>
																	)}
																	{order.status === "CANCELLED" && (
																		<div className='bg-yellow-100 text-yellow-800 text-sm rounded-xl px-4 py-2 shadow-inner border border-yellow-300 mt-1'>
																			...
																			Please contact the store for more
																			information.
																		</div>
																	)}
																</div>
														...
														<div className='flex justify-between items-center'>
															...
															<div className='space-x-2'>
																<button
																	onClick={() => {
																		setShowAddressForm(true);
                                    setEditAddress([true, address.id]);
                  ...
                  editAddress={editAddress[0]}
                  addressId={editAddress[1]}
								/>
							</motion.div>
						)}
					</div>
